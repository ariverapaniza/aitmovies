...
echo '<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6"><H3> Add Actor Information!</H3><br>
...
echo '<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <br>
            <form action="form_process_actors.php" method="POST" class="text-left">
                ...
                <input type="submit" class="btn btn-primary" value="Add Actor"><br>
            </form>
            <br>
        </div>
    </div>
